...
**Checklist à appliquer à chaque faction importée.** Cocher au fur et à mesure.

## Indépendant

Tous les **personnages nommés**, sauf Key le Sénéchal et Karl VI (Khârns) et **Muskh** (Fangs).
Plus :

- Khârns : les **Avant-gardes**.
- Khérops : les **Berserkers**.
- Fangs : les **Exécuteurs**. — ✅ appliqué (Exécuteurs I/II/III, Apathée, Broutcha, Xayìn ; Muskh/Djouked déjà).
- Goûns : les **éclaireurs mongo**.

## Merci

- Khârns : le Prince, Engueran, les Paladins.
- Goûns : le Père de Famille.
- Guilde Noire : Mathys, Gakere.

## Riposte

- Khérops : Tarsak.
- (Pacts/Formations peuvent en octroyer d'autres temporairement — hors profil.)

## Rusé

- Khârns : Avant-gardes niveau III.
- Fangs : **Goulues niveau II** et **Meneuses niveau II**. — ✅ appliqué.
- Goûns : Guerriers Mongo niveau III.

## Bond 4

- Khârns : Syrga et l'Avant-garde khârne niveau III.
...
- Fangs : Broutcha (1), Apathée (1). — ✅ appliqué.
- Goûns : pas de SDG fixe ; le leader génère 1 marqueur par multiple complet de 4 niveaux I.
